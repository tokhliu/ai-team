...
export const TOOLS: Tool[] = [
  ...
  { id: 'qrcode', category: 'dev', slug: 'qrcode', nameKey: 'tools.qrcode.name', descriptionKey: 'tools.qrcode.description', icon: 'QrCode', searchTerms: ['qrcode', 'qr code', 'qr', '二維碼', '條碼', 'barcode', 'generate qr'] },
  { id: 'epoch', category: 'dev', slug: 'epoch', nameKey: 'tools.epoch.name', descriptionKey: 'tools.epoch.description', icon: 'Clock4', searchTerms: ['epoch', 'unix timestamp', 'timestamp', '時間戳', 'unix time', '時間轉換', 'epoch converter'] },
  // Image Tools
